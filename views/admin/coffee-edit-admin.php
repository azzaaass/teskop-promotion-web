...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($connection, "UPDATE coffee SET image_url='$linkGambar', description='$description' ,name='$name', price='$price' WHERE id=$id");
...
?>
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <form action="<?php echo BASE_URL; ?>/views/admin/coffee-edit-admin.php" method="post" enctype="multipart/form-data">
