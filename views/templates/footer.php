...
<footer class="bg-white">
    ...
    <div class="text-center py-8 bg-black">
        <a href="#" class="flex items-center justify-center mb-5 text-2xl font-semibold text-white">
            <img src="../public/images/telu.png" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
            Teskop
        </a>
        ...
        <span class="block text-sm text-center text-gray-500">©Teskop - PemWeb Big Project
            Created by 9th Teams.
        </span>
